    ...
    try {
      ...
      if (action === "on") {
        ...
        if (initialNews) {
          ...
          reply("* chama-md Warning:* Failed to fetch initial lankadipa news. API may be down. Continuing with updates...");
        }
